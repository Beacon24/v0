...
module.exports.register = async (req, res, next) => {
    try {
        ...
        const { email, username, password, location, bio, offerings, needs, geometry, images } = req.body;
        const user = new User({ email, username, location, bio, offerings, needs, geometry, images });
